...
async def incoming_start_message_f(bot, update):
        ...
        try:
            ...
            if user.status == "kicked":
                await message.reply_text(
                    text="Sorry Sir, You are Banned to use me. Contact my Flower.",
                    parse_mode="markdown",
            ...
            await message.reply_text(
                text="Something went Wrong. Contact my Flower.",
                parse_mode="markdown",
                disable_web_page_preview=True
            )
            return
    await bot.send_message(
        ...
        reply_markup=InlineKeyboardMarkup(
            [
                [
                    InlineKeyboardButton('Updates Channel', url='https://t.me/Video_Compressor_TG_Robot')
                ],
                [
                    InlineKeyboardButton('Support Group', url='https://t.me/Video_Compressor_TG_Robot')
                ]
            ]
        ),
